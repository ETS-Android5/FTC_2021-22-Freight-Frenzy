...
@Autonomous(name="Auto_RightSide", group="")
public class Auto_RightSide extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        timmer.reset();
        while(timmer.milliseconds() < 1700) {
            correction = checkDirection();
            LB_Drive.setPower(power * 1);
            RB_Drive.setPower(power * -1);
            LF_Drive.setPower(power * -1);
        ...
        timmer.reset();
        while(timmer.milliseconds() < 1350) {
            LB_Drive.setPower((power*-1));
            RB_Drive.setPower((power*1));
            LF_Drive.setPower((power*-1));
            RF_Drive.setPower((power*1));
        ...
        timmer.reset();
        while(timmer.milliseconds() < 2250) {
            LB_Drive.setPower(power * -1);
            RB_Drive.setPower(power * 1);
            LF_Drive.setPower(power * 1);
            RF_Drive.setPower(power * -1);
